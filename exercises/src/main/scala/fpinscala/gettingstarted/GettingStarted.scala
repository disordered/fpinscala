...
object PolymorphicFunctions {
  ...
  def main(args: Array[String]): Unit = {
    println(isSorted(Array(1), (first: Int, second: Int) => first <= second))
    println(isSorted(Array(1, 2), (first: Int, second: Int) => first <= second))
    println(isSorted(Array(1, 2, 3), (first: Int, second: Int) => first <= second))
    println(isSorted(Array(1, 3, 2), (first: Int, second: Int) => first <= second))
    println(isSorted(Array(3, 2, 1), (first: Int, second: Int) => first <= second))
    println(isSorted(Array(1, 2, 2), (first: Int, second: Int) => first <= second))
    println(isSorted(Array(3, 2, 2), (first: Int, second: Int) => first <= second))
